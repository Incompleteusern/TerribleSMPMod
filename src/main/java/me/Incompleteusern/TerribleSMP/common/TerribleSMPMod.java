package me.Incompleteusern.TerribleSMP.common;
...
public class TerribleSMPMod implements ModInitializer {

	public static String MODID = "terrible-smp";
